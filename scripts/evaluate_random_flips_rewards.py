...
"""
This script evaluates the random flip sweep accuracy of all the merged models in their output directory.
"""

def main():
    parser = argparse.ArgumentParser(description="Evaluate all GRPO label flip and seed sweep checkpoints.")
    parser.add_argument("--runs_dir", type=str, default="Your_Runs_Directory", help="Root directory of the flip/seed runs.")
    ...
    parser.add_argument("--results_file", type=str, default="flip_sweep_summary.jsonl", help="File to save all results.")
    ...
    # Print Final Summary
    print("\n\n--- Flip/Seed Sweep Evaluation Summary ---")
